	...
	<div id="photos">
		<div class="inner container">
			...
			<footer class="photos-footer">
				<p class="no-margin">
					<a href="<?php echo get_permalink(get_gbteddybear_option('submit_photo_page_id')); ?>" class="uppercase"><i aria-hidden="true" class="icon-camera big text-middle"></i>&nbsp;&nbsp;<?php _e("Upload your photos to here!", THEME_NAME) ?></a>
				</p>
