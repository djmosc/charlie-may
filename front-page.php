...
<section id="front-page" class="clearfix">
	...
	if($query->have_posts()):
		...
		$gallery_page_id = get_charlie_may_option('gallery_page_id');
	?>
	<div id="photos">
		<div class="inner container">
			...
			<footer class="photos-footer">
				<p class="no-margin">
					<a href="<?php echo get_permalink(get_charlie_may_option('submit_photo_page_id')); ?>" class="uppercase"><i aria-hidden="true" class="icon-camera big text-middle"></i>&nbsp;&nbsp;<?php _e("Upload your photos to here!", THEME_NAME) ?></a>
				</p>
